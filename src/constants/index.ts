...
export const navItems = [
  ...
  { href: "/chat", label: "Chat", icon: MessageSquare, roles: ["owner", "admin", "staff"] },
  ...
  { href: "/sales-orders", label: "Sales Orders", icon: FileText, roles: ["owner", "admin"] },
  ...
  { href: "/purchase-orders", label: "Purchase Orders", icon: ReceiptText, roles: ["owner", "admin"] },
  { href: "/ap-invoices", label: "AP Invoices", icon: ScrollText, roles: ["owner", "admin"] },
