...
export function Header({ name, email, role, permissions = null, notifications = [], unreadCount = 0 }: { name: string; email: string; role: Role; permissions?: Permissions | null; notifications?: any[]; unreadCount?: number }) {
  return (
