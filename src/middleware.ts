...
export const config = {
  matcher: ["/((?!api/auth|api/reminders|api/attendance/device|_next/static|_next/image|favicon.ico|icon.svg|manifest.webmanifest|sw.js|pwa|login|forgot-password|reset-password).*)"]
};
