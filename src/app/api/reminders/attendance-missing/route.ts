...
import { sendMissingAttendanceReminders } from "@/services/attendance-reminders";
...
export async function GET(request: NextRequest) {
  ...
  const result = await sendMissingAttendanceReminders({ force: request.nextUrl.searchParams.get("force") === "true" });
